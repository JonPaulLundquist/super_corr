...
# -*- coding: utf-8 -*-
"""
Kernel for the UHECR wedge scan using Lundquist's Lambda correlation.
...
- Evaluates Lundquist's Lambda correlation / p-value on surviving event subsets.
- Tracks best |Lambda|-scan significance and best Lambda<0 significance.
...
def _scan_center(energies, separation, azimuthal, directions, Ecuts,
    ...
    |Lambda|-scan and Lambda<0 scan results.
    ...
    minN : int
        Minimum number of events required to evaluate Lambda correlation.
    ...
    return (best_lambda, best_p, best_E, best_dir, best_distance, best_width, best_N,
